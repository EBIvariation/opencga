...
public class DocumentToVariantSourceConverterTest {
    ...
    public void testConvertToStorageType() {
        ...
        assertEquals(mongoSource.get(DocumentToVariantSourceConverter.FILENAME_FIELD), converted.get(
                DocumentToVariantSourceConverter.FILENAME_FIELD));
        assertEquals(mongoSource.get(DocumentToVariantSourceConverter.FILEID_FIELD), converted.get(
                DocumentToVariantSourceConverter.FILEID_FIELD));
        assertEquals(mongoSource.get(DocumentToVariantSourceConverter.STUDYNAME_FIELD), converted.get(
                DocumentToVariantSourceConverter.STUDYNAME_FIELD));
        assertEquals(mongoSource.get(DocumentToVariantSourceConverter.STUDYID_FIELD), converted.get(
                DocumentToVariantSourceConverter.STUDYID_FIELD));
        // Exclude the date
        assertEquals(mongoSource.get(DocumentToVariantSourceConverter.SAMPLES_FIELD), converted.get(
                DocumentToVariantSourceConverter.SAMPLES_FIELD));
        ...
        assertEquals(expectedMetadata.get("FORMAT" + DocumentToVariantSourceConverter.CHARACTER_TO_REPLACE_DOTS + "A"), convertedMetadata.get("FORMAT" + DocumentToVariantSourceConverter.CHARACTER_TO_REPLACE_DOTS + "A"));
    }
